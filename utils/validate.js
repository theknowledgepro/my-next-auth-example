...
export const validate = {
	...
	username: ({ username }) => {
		const errMsg =
			(!username && 'Please provide a username for your account.') ||
	...
	password: ({ password }) => {
		...
		if (strongPassword.test(password)) {
			...
			passwordStrength = 0;
			passwordStrengthAdvice =
				'Password should contain at least a capital and lowercase letter, a number, and a special characters and must be 8 characters long.';
		} else {
			passwordStrength = -1;
			passwordStrengthAdvice =
				'Password should contain at least a capital and lowercase letter, a number, and a special character and must be 8 characters long.';
		}
